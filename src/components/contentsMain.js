            ...
            <View style={{marginBottom:10}}>
                <View style={myPageFormStyle.contentsLayout2}>
                    ...
                    <View style={{justifyContent:'center', alignItems:'center'}}>
                        <Text style={{textAlignVertical:'center',textAlign: "center", fontSize:18, fontWeight:'bold', color:'#8c8c8c', paddingTop:20, paddingBottom:20, lineHeight:24}}>브랜드 프로파일링은{"\n"}브랜드 컨셉과 생활용품 제품 개발을{"\n"}위한 특화 리서치 툴입니다.</Text>
                    </View>
                    ...
                    <View style={{paddingLeft:40, paddingRight:40, marginBottom:20}}>
                        <Text style={{fontSize:12, color:'#8c8c8c', lineHeight:24, letterSpacing:-1.2}}>1. 브랜드의 포지셔닝을 진단하거나 전략을 도출하기 위해 사용합니다.</Text>
                        <Text style={{fontSize:12, color:'#8c8c8c', lineHeight:24, letterSpacing:-1.2}}>2. 브랜드의 상징가치, 개성 들 브랜딩에 사용되는 모든 이론과 방법론이 총 망라되어 있습니다.</Text>
                        <Text style={{fontSize:12, color:'#8c8c8c', lineHeight:24, letterSpacing:-1.2}}>3. 제품 개발을 위한 소비자 리서치를 쉽고 빠르게 할 수 있으며 창의적인 아이디어를 도출하도록 도와드립니다.</Text>
                    </View>
