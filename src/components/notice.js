                ...
                <Content style={{padding:10}}>
                    <View style={TermsFormStyle.contentsLayout}>
                        <View style={{paddingTop:5, paddingBottom:5}}>
                            <Text style={TermsFormStyle.title}><Text style={TermsFormStyle.boldFont}>Brand Profiling</Text> 개인정보취급방침</Text>

                            <Text style={TermsFormStyle.subtitle}>(주)퍼셉션('BrandProfiling')은(는)</Text>

                            <Text style={TermsFormStyle.contentsSize}>
                                <Text>BrandProfiling는 개인정보취급방침을 개정하는 경우 http://brandprofiling.co.kr/ 또는 모바일 앱의 ‘공지사항’(또는 개별공지)을 통 하여 공지할 것입니다.</Text>
                            </Text>
